...
public class paneling extends JPanel {
    public paneling() {
    ...
    protected static ImageIcon createImageIcon(String path,
                                               String description) {
        java.net.URL imgURL = paneling.class.getResource(path);
        if (imgURL != null) {
    ...
    private static void createAndShowGUI() {
        ...
        paneling newContentPane = new paneling();
